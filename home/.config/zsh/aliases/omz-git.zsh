# Oh My Zsh's git plugin (ohmyzsh/ohmyzsh@74965c9), ported plugin-free.
# Skipped because git.zsh already owns them: g ga gb gc gca gco gd gds gl gp.
# Also dropped: gg/gga/gk/gke (no gitk or git gui here) and the git-svn ones.
# git is new enough (>= 2.30) that OMZ's version checks are gone.

# From OMZ's lib/git.zsh — the branch name, or the short sha when detached.
