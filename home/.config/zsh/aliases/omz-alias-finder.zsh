# Oh My Zsh's alias-finder plugin (ohmyzsh/ohmyzsh@74965c9), ported plugin-free.
# Before each command runs, prints any alias you could have typed instead. Turn the
# hint off with `zstyle ':omz:plugins:alias-finder' autoload no`; `alias-finder
# git status` still works on demand.
