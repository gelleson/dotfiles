# Oh My Zsh's kubectl plugin (ohmyzsh/ohmyzsh@74965c9), ported plugin-free.
# Aliases only — no kubectl completion is set up here. Dropped ky (needs yh).
