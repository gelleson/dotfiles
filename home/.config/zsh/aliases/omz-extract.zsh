# Oh My Zsh's extract plugin (ohmyzsh/ohmyzsh@74965c9), ported plugin-free.
# `extract file.tar.gz` unpacks any archive into its own folder; -r deletes the
# archive afterwards. Skipped OMZ's `x` alias — that's your codex shortcut.
